...
import AboutUs1Date from "../../data/kingdom-valley/about.json";
              ...
              <div className="row">
                <div className="col-md-5 cmd-padding valign">
                  <div className="img1 wow imago" data-wow-delay=".5s">
                    <img src={AboutUs1Date.image1} alt="kingom-valley-image" />
                  </div>
                </div>
                <div className="col-md-7 cmd-padding">
                  <div className="img2 wow imago" data-wow-delay=".3s">
                    <img src={AboutUs1Date.image2} alt="kingom-valley-image" />
                  </div>
                  <div className="img3 wow imago" data-wow-delay=".8s">
                    <img src={AboutUs1Date.image3} alt="kingom-valley-image" />
                  </div>
                </div>
              </div>
            </div>
