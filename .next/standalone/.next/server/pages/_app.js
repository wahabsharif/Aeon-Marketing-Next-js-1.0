...
const FloatingWA = ()=>{
    const openWhatsAppChat = ()=>{
        ...
        const whatsappUrl = `https://api.whatsapp.com/send?phone=${923235154682}&text=${encodeURIComponent(message)}`;
...
var __webpack_exports__ = __webpack_require__.X(0, [699,2455], () => (__webpack_exec__(3319)));
